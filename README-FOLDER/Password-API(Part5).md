...
- 5.1 Create a custom error class, `Location:./utils/errorResponse.js`
- 5.2 Create a custom error middleware , `Location:./middleware/error.js`
- 5.3 Add errorHandler middleware to server, `Location:./server.js`

- 5.4 Add error creators in route middlewares (protect & authorize).`Location:./middlesware/auth.js`
- 5.5 Add error creators in route methods.`Location:./controllers/auth.js`
